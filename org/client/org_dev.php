...
class org extends Controller
{
    ...
    function user()
    {
        if (isset($_GET['action']) && $_GET['action'] == 'list') return $this->run('user/list_user');
        if (isset($_GET['action']) && $_GET['action'] == 'approve') return $this->run('user/approve_user');
        if (isset($_GET['action']) && $_GET['action'] == 'delete') return $this->run('user/delete');
        if (isset($_GET['action']) && $_GET['action'] == 'view') return $this->run('user/info_user');
