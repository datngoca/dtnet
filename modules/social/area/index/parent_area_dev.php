...
/*select lang */
/*$array_lang = $this->request_api("language", "list");
	if($array_lang != null ) array_unshift($array_lang , array("code" => "", "name" => "..."));
	else $array_lang[] = array("code" => "", "name" => "...");
	$select_lang = $Html->Form->selectbox(array("name" => "data[lang]", "id" => "select_lang"), $array_lang, $lang);*/
