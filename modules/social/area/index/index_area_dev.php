...
$button_search = $Form->button(array("class" => "search", "type" => "button", "onclick" => 'list_area()'), "Search");
$button_input = $Form->button(array("class" => "add right", "type" => "button", "onclick" => "input_area('')"), "Add new");
