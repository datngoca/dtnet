...
$array_area_data = $this->request_api("area", "info_all", array("area" => $uid_area));
$array_area = isset($array_area_data["data"]) ? $array_area_data["data"] : [];
...
$button_status = $Form->button(array("id" => "button_status", "type" => "button", "onclick" => "activate_area('$uid_area')"), $label_button_status);
