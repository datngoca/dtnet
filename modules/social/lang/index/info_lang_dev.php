...
$array_lang_user_data = $this->request_api("language", "info_my", ["lang" => $uid_lang_user]);
...
$button_edit = $Form->button(array("class" => "edit", "type" => "button", "onclick" => "input_lang('$uid_lang_user')"), "Chỉnh sửa");
$button_delete = $Form->button(array("class" => "delete", "type" => "button", "onclick" => "delete_lang('$uid_lang_user')"), "Xóa");
...
if ($array_language !== null) {
    ...
    $form_row_main .= $Form->row("Trạng thái", $array_language['status'] == "1" ? "Mở" : "Đóng");
