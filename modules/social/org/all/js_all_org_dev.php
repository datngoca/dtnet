<script>
    var url_org = "<?php echo $this->get_link(array("controller" => "org", "function" => "all")) ?>";
    ...
    function activate_org() {
        var url_activate_org = url_org;
        url_activate_org += "?action=activate&org=" + uid_org_user_selected;

        return get_data(url_activate_org, null, show_actiave_org, "div_msg");
    }
</script>