...
$button_input = $Form->button(array("class" => "add right", "type" => "button", "onclick" => "input_org('')"), "Input new");
$button_input_exist = $Form->button(array("class" => "add right", "type" => "button", "onclick" => "input_org('')"), "Add Exist");

/*form search content*/
$form_search_content =  $div_lang . $str_area . $input_search . $button_search . $button_input . $button_input_exist;
