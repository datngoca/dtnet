...
$array_org_user_data = $this->request_api("org", "info_my", ["org" => $uid_org_user]);
...
/* button edit */
$button_edit = $Html->Form->button(array("type" => "button", "class" => "edit", "onclick" => "input_org('$uid_org_user')"), "Edit");
...
if ($array_org != null) {
    ...
    /*str_place*/
    $str_place_right = $place_name_in . "($place_code_in)";
