<script>
    var url_post = "<?php echo $this->get_link(array("controller" => "post", "function" => "all")) ?>";
...
>>>>>>> ecb0f9b (updated from huy's computer)
    ...
    function show_activate_post(obj) {
        console.log("obj", obj);
    ...
    function activate_post() {
        var url_activate_post = url_post;
        url_activate_post += "?action=activate&post=" + uid_post_user_selected;

        return get_data(url_activate_post, null, show_activate_post, "");
    }
</script>