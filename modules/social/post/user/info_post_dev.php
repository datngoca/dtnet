...
$array_post_user_data =  $this->request_api("post", "info_user", ["post" => $uid_post_user]);
...
/* button edit */
$button_approve = $Html->Form->button(array("type" => "button", "class" => "edit", "onclick" => "approve_post('$uid_post_user')"), "Approve");
...
if ($array_post_user['approved'] != "1") $form_row .= $Html->Form->row("", $button_approve);
