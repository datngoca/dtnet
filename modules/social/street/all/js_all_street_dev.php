<script>
    var url_street = "<?php echo $this->get_link(array("controller" => "street", "function" => "all")) ?>";
    ...
    function list_street() {
        ...
        url_list_street = url_street;
        if (!url_list_street.includes("?")) url_list_street += "?";

        url_list_street += "action=list&area=" + area_str_code + "&lang=" + lang + "&search=" + str_search;

        return get_page(url_list_street, null, show_list_street, "div_msg");
    }
    ...
    function view_cross_street_tab() {
        ...
        var url_street_cross = "<?php echo $this->get_link(array("controller" => "street", "function" => "all", "get" => "action=cross")) ?>";
    ...
    function get_list_area_street_cross() {
        var url_list_area_street_cross = url_street;
        if (!url_list_area_street_cross.includes("?")) url_list_area_street_cross += "?";

        url_list_area_street_cross += "action=list_cross&street=" + uid_street_user_selected;
    ...
    function show_activate_street(obj) {
    ...
    function activate_street() {
        var url_activate_street = url_street;
        if (!url_activate_street.includes("?")) url_activate_street += "?";
        url_activate_street += "action=activate&street=" + uid_street_user_selected;

        return get_data(url_activate_street, null, show_activate_street, "window_street_msg");
    }

    function view_detail_street() {
        //loading('window_street_msg');
        var url_street_detail = url_street;
        if (!url_street_detail.includes("?")) url_street_detail += "?";
        url_street_detail += "action=info&street=" + uid_street_user_selected;
