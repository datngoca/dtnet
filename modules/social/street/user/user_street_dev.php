...
if ($area_str_code == '') $area_str_code = $this->Cookie->get('area');
if ($area_str_code == '') $area_str_code = "vietnam";
...
/* table area */
//$div_table_street_left = $Html->div("", "id='div_street_table' class= 'w40 left'");
// $div_table_street_right = $Html->div("", "id='div_street_table_right' class= 'w40 right'");

$div_table_street_left = $Html->div("", "id='div_street_table'");


echo $Html->div($form_search . $div_table_street_left, "id='div_street_list'");
