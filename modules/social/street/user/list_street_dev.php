...
$array_user_street_data = $this->request_api("street", "list_user", ["search" => $search, "area" => $area_str_code, "lang" => $lang]);
...
if ($array_user_street != null) {
    foreach ($array_user_street as $row) {
        ...
        $str_user =  "$user_fullname <br><span class='des2'>$username</span>";
        ...
        $table_row .= $Table->row(array($stt, $lang, $str_name, $str_area, $str_status, $str_user, $button_detail));
    }
} else {
...
$table_header = $Table->row_header(array("Stt", "Lang", "Name", "In Area", "Status", "User", "View"));
