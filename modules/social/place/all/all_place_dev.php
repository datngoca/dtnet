...
$span_place_input = $Html->span("", "id='span_place_input'");
echo $Html->div($span_place_input, "id='div_input' style='display:none'");
...
/* Xác định area hiện tại */
$area_str_code_root = '';
$array_area_setting = null;
$array_area_root = null;
if ($array_area_setting != null && isset($array_area_setting['data'])) $array_area_root = $array_area_setting['data'];
...
/*form search */
$url_search = $this->get_link(array("controller" => "all_place", "function" => "index"));
$form_search = $Form->get(array("method" => "GET", "action" => $url_search), $form_search_content);

/*Danh sách place*/
$list_title = $Html->span('All Places');
...
<script>
    ...
    $(document).ready(function() {
        ...
        window_place_content += "<div id = 'div_place_tab'>tab</div>";
