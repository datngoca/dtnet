<script>
    var url_place = "<?php echo $this->get_link(array("controller" => "place", "function" => "user")) ?>";
    ...
    function show_approve_place(obj_result) {
        ...
        show_place_info(uid_place_user_selected);
    }

    function approve_place() {
        var url_approve_place = url_place;
        url_approve_place += "?action=approve&place=" + uid_place_user_selected;

        return get_data(url_approve_place, null, show_approve_place, "window_place_msg");
    }

    function view_detail_place() {
        //loading('window_place_msg');
        var url_place_detail = url_place;
        url_place_detail += "?action=info&place=" + uid_place_user_selected;
